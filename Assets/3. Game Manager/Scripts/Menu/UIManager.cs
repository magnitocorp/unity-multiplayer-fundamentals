...
public class UIManager : Manager<UIManager>
{
    ...
    [SerializeField] private Text SinglePlayerTagLine;
    [SerializeField] private Text LanTagLine;
    [SerializeField] private Text OnlineTagLine;
    ...
    {
        SinglePlayerTagLine.gameObject.SetActive(!fadeOut);
        OnlineTagLine.gameObject.SetActive(!fadeOut);
        LanTagLine.gameObject.SetActive(!fadeOut);
    ...
    private void Update()
    {
        ...
        /* Behaviour moved to SinglePlayerController 
    ...
    public void HideUI()
    {
        ...
        SinglePlayerTagLine.gameObject.SetActive(false);
